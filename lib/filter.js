...
Meteor.startup( function (){
  ...
  if(Meteor.isClient){
    ...
    //Router.onBeforeAction(filters.isLoggedIn, {except: ['home', 'atSignIn', 'atResetPwd','atEnrollAccount', 'atForgotPwd', 'atVerifyEmail', 'organization.create']});

    // @@TODO: change only to except
    Router.onBeforeAction(filters.isMember, {only: ['organization.home', 'organization.invite', 'user.home']});
