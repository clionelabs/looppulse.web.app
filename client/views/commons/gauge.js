...
Template.gauge.updateGauge = function(data) {
  ...
  var arcTween = function(d) {
    var iFunc = d3.interpolateNumber(0 , d.value * Math.PI * 2);
    return function (t) {
      d.value = iFunc(t);
      return arc(d);
    }
  ...
  var arc = d3.svg.arc()
    ...
    .endAngle(function(d) { return d.value; })
      .outerRadius(function(d) { return (circleWidth / 2) - (d.index * 10); })
      .innerRadius(function(d) { return (circleWidth / 2) - 10 - (d.index * 10); });


  var path = circular.selectAll("path").data(_.map(data.percentage, function(d,i) { return { value : d, index : i}; }));
